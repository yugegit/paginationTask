var tableArr=[
  ...
  btn.addEventListener('click',(e) =>{
      ...
      tableArr.map ((e) =>{
        ...
        tr.innerHTML=`<td>${e.id}</td> <td>${e.name}</td> <td>${e.email}</td>`
        tbody.append(tr)
      ...
      const data = document.getElementsByTagName('tbody')
      console.log(data[0])
      console.log(tableArr.slice(0,9))
      console.log(tableArr.slice(10,19))
      console.log(tableArr.slice(20,29))
      console.log(tableArr.slice(30,39))
      console.log(tableArr.slice(40,49))
      console.log(tableArr.slice(50,59))
      console.log(tableArr.slice(60,69))
      console.log(tableArr.slice(70,79))
      console.log(tableArr.slice(80,89))
      console.log(tableArr.slice(90,99));
